...
subplot(3,1,2)
plot(states(:,2),'r-','LineWidth',1.5);
hold on;
plot(states2(:,2),'b-.','LineWidth',1.5);
hold on;
%plot(states4(:,2),'k--');
%hold on;
plot(states3(:,2),'color',[0.4,0.6,0.2],'LineWidth',1.5);
grid on;
xlabel('Time (t)');
ylabel('Output 2');
subplot(3,1,3)
plot(states(:,3),'r-','LineWidth',1.5);
hold on;
plot(states2(:,3),'b-.','LineWidth',1.5);
hold on;
%plot(states4(:,3),'k--');
%hold on;
plot(states3(:,3),'color',[0.4,0.6,0.2],'LineWidth',1.5);
xlabel('Time (t)');
ylabel('Output3');
