...
subplot(2,1,1)
plot(states(1:120,1),'r-');
hold on;
plot(states2(1:120,1),'b-');
hold on;
plot(states3(1:120,1),'color',[0.4 0.6 0.2]);
grid on;
xlabel('Time (t)');
...
subplot(2,1,2)
plot(log10(abs(states(1:250,1)'-ref(1:250))),'r-');
hold on;
plot(log10(abs(states2(1:250,1)'-ref(1:250))),'b-');
hold on;
plot(log10(abs(states3(1:250,1)'-ref(1:250))),'color',[0.4 0.6 0.2]);
grid on;
xlabel('Time (t)');
