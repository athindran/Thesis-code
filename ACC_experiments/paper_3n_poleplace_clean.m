...
perturb2 = rand(3,3);
Aest2 = Ad+1.7*perturb2/norm(perturb2);
smooth = ones(1,T);
...
figure
plot(inputnorm1,'r-','LineWidth',1.5);
hold on;
plot(inputnorm2,'b-','LineWidth',1.5);
hold on;
plot(inputnorm3,'color',[0.4 0.6 0.2],'LineWidth',1.5);
xlabel('Time (t)');
ylabel('Input norm');
legend('Agg','Cons','CVX control');

subplot(2,1,1)
plot(states(1:120,1),'r-','LineWidth',1.5);
hold on;
plot(states2(1:120,1),'b-','LineWidth',1.5);
hold on;
plot(states3(1:120,1),'color',[0.4 0.6 0.2],'LineWidth',1.5);
grid on;
xlabel('Time (t)');
ylabel('Output to be tracked');
ylim([-30,40])
legend('Aggressive','Conservative','CVM control');
title('Sinusoid tracking');
set(gcf, 'Units', 'Inches', 'Position', [0, 0, 5.95*2, 5.95/2], 'PaperUnits', 'Inches', 'PaperSize', [5.95*2, 5.95/2])
saveas(gcf,'./general_figures/general_32n.eps','epsc');

subplot(2,1,2)
plot(log10(abs(states(1:250,1)'-ref(1:250))),'r-','LineWidth',1.5);
hold on;
plot(log10(abs(states2(1:250,1)'-ref(1:250))),'b-','LineWidth',1.5);
hold on;
plot(log10(abs(states3(1:250,1)'-ref(1:250))),'color',[0.4 0.6 0.2],'LineWidth',1.5);
grid on;
xlabel('Time (t)');
...
saveas(gcf,'./paper_figures/general_324n.eps','epsc');
...
%saveas(gcf,'./general_figures/general_16n.eps','epsc');
...
%saveas(gcf,'./general_figures/general_156n.eps','epsc');
